# submit_driver.sh
#BSUB -J g05_T           # job name
#BSUB -q fotonano                    # queue name
#BSUB -n 80                     # total cores (max 128 for hpc, max 360 for fotonano)
#BSUB -R "span[ptile=80]"       # max cores/node (max 20 for hpc)
...
mpirun python3 run_potts_sweep.py --config configs/260124_gset_max-3-cut_convergence_time_step_qpdc.yaml
