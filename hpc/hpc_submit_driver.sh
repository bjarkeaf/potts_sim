# submit_driver.sh
#BSUB -J m3_qpdc           # job name
#BSUB -q hpc                    # queue name
#BSUB -n 60                    # total cores (max 128 for hpc, max 360 for fotonano)
#BSUB -R "span[ptile=60]"       # max cores/node (max 20 for hpc)
...
mpirun python3 run_potts_sweep.py --config configs/260116_gset_max-3-cut_qpdc.yaml
