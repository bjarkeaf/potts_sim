# submit_driver.sh
#BSUB -J m4_dT           # job name
#BSUB -q fotonano                    # queue name
#BSUB -n 26                     # total cores (max 128 for hpc, max 360 for fotonano)
#BSUB -R "span[ptile=26]"       # max cores/node (max 20 for hpc)
...
mpirun python3 run_potts_sweep.py --config configs/260114_gset_max-4-cut_convergence_time_step_qpdc.yaml
