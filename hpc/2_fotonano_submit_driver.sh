...
#BSUB -n 96                     # total cores (max 128 for hpc, max 360 for fotonano)
...
mpirun python3 run_potts_sweep.py --config configs/260124_gset_max-3-cut_convergence_sim_time_qpdc.yaml
