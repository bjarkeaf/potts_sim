# submit_driver.sh
#BSUB -J m3_dT           # job name
#BSUB -q fotonano                    # queue name
#BSUB -n 50                     # total cores (max 128 for hpc, max 360 for fotonano)
#BSUB -R "span[ptile=50]"       # max cores/node (max 20 for hpc)
...
mpirun python3 run_potts_sweep.py --config configs/260114_gset_max-3-cut_convergence_time_step_qpdc.yaml
