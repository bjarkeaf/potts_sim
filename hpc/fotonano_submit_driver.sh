...
#BSUB -n 360                     # total cores (max 128 for hpc, max 360 for fotonano)
#BSUB -R "span[block=20]"       # max cores/node (max 20 for hpc)
...
mpirun python3 run_potts_sweep.py --config configs/250602_gset.yaml
